         ...
         <div class="content contact-content">
            ...
            <div class="item-container">
                <div class="card-item-top">
                 ...
                 <div class="card-item-top">
                    ...
                    <div class="top-card-item-container_title">
                        <h2 class="title_2">Téléphone</h2>
                    </div>
                    <div class="top-card-item-container-list">
                        <ul>
                            <li>(+243) 973 524 123</li>
                 ...
                 <div class="card-item-top">
                    ...
                    <div class="top-card-item-container-list">
                        <ul>
                            <li>Av. Lukusa n.16 C. Kinshasa/Gombe. B.P 9502, Kinshasa</li>
            ...
            <div class="item-container-mid">
                ...
                <div class="item-content-mid">
                    <div class="item-container-mid-left">
                        ...
                        <h2 class="title_2">Votre opinion nous est précieuse, alors contactez-nous dès aujourd’hui, nous saurons vous lire.</h2>
                        <form class="item-container-mid-left-content">
                            ...
                            <div class="item-container-mid-left-content-1">
                                ...
                                <div class="item-container-mid-left-content-1-1">
                                    ...
                                    <input type="text" mame="first-name" placeholder="Noms">
                                    <input type="text" mame="adress" placeholder="Email">
                                </div>
                                <div class="item-container-mid-left-content-1-2">

                                     <input type="text" mame="email" placeholder="Téléphone">
                                     <input type="text" mame="sujet" placeholder="Sujet">
                                </div>
                            </div>
            ...
            <div class="item-container-bottom">
                ...
                <div class="item-content-bottom">
                    ...
                    <h2 class="title_2">Retrouvez-nous facilement grâce à la carte ci-dessous. Nous serons ravis de vous accueillir.</h2>
