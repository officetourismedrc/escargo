...
//  end menu reveal and hide ==============
// preloader ==================================

// if(preLoaderCounter !== null){

// function startPreloaderCounter(){

//   let preLoaderCounter = document.querySelector('.pre-loader-counter');
//   let preloaderCurentNumber = 0;
  
//   function updateCounterPreloader(){
//     if(preloaderCurentNumber === 100)
//     {
//       return;
//     }
//     preloaderCurentNumber += Math.floor(Math.random()*10) + 1;

//     if(preloaderCurentNumber >  100)
//     {
//       preloaderCurentNumber = 100;
//     }

//     preLoaderCounter.textContent = preloaderCurentNumber;

//     let dalay = Math.floor(Math.random() * 200 )+ 50;
//     setTimeout(updateCounterPreloader, dalay);
//   }

//   updateCounterPreloader();
...
//     onComplete: ()=> {
//       document.querySelector('.pre-loader-overlay').style.display = 'none'; 
//      }
//   });
// });
...
function colorChangeMenuLogo(){
  ...
  chevronMenu.src = assetChevronBlue;
}
function colorChangeMenuReverseLogo(){
  ...
  chevronMenu.src = assetChevronWhite;
