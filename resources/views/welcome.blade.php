...
@vite(['resources/css/app.css', 'resources/js/app.js'])
    ...
    <body  {{-- class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col" --}} >
      <!-- <div class="pre-loader-counter">0</div>
    <div class="pre-loader-overlay">
        <div class="pre-loader-bar"></div>
        <div class="pre-loader-bar"></div>
        <div class="pre-loader-bar"></div>
        <div class="pre-loader-bar"></div>
        <div class="pre-loader-bar"></div>
 ...
 <!-- <div class="pre-loader">
    ...
    <header class="header">
        <div class="header-cotainer">         
                 ...
                 <div class="logo-adjuster">
                    <img src="{{ asset('/images/logo_color_ont_paysage.png') }}" alt="logo de l'office national du tourisme rd congo" class="logo-img">
                    {{--
                                 public/images/logo_color_ont_paysage.png
                    --}}
                 </div>
                </a>        
             <div class="nav">
                 ...
                 <div class="nav-bottom">
                    <div class="nav-bottom-menu">
                        <di class="nav-bottom-menu-container">
                            ...
                            <div class="nav-search">
                                <div class="nav-search-adjuster">
                                    <span>
                                        
                                        <form action="" class="search-site">
                                            <input class="search-input-site" type="text">
                                            <button class="search-site-button"><i class="fa-solid fa-magnifying-glass"></i></button>
                                        </form>
                            ...
                            <!-- ==== mobikle section only deactivate on big screen =====-->
    ...
    <main class="main">
        ...
        <section class="hero_section">
            ...
            <div class="hero-slider">
                <div class="swiper">
                  ...
                  <div class="controls">
                    <button class="pause-btn" aria-label="Pause/Play">:double_vertical_bar:</button>
        ...
        <!-- section info simple -->
    @include('components.sections.trois-cards-section')
...
@include('components.sections.qui-sommes-nous')
        ...
        <!-- ======section contacts =========== -->
       @include('components.sections.statistiques-office')
       <!-- end section divers -->

       @include('components.sections.vision-managerial')
 ...
 @include('components.sections.marquees')
  <!-- =====end infinite sliding social media icon ===========-->
...
<!-- 
       ...
       <x-article-section />
        ...
        @include('components.sections.nos-partennaires')

       <!-- == end section nos partennaires === -->
